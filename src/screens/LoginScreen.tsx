  ...
  return (
    ...
    <StyledView className='flex-1 flex-col justify-between pt-5 pb-8 bg-beige-lino'>
      ...
      <StyledView className='-mb-40'>
        <StyledImage source={login} className='h-[60%] w-screen self-center'></StyledImage>
      </StyledView>

      {/* Content */}
      <StyledView className='flex flex-col m-8'>
        <StyledText className='text-black font-bold text-4xl text-left'>Inicio de Sesión</StyledText>
        <StyledText className='text-black text-justify pt-8 pb-8 text-xl font-light'>Para empezar a usar la aplicacion y tomar control de tu tiempo, ingresa con tu cuenta de Google</StyledText>
      </StyledView>
      ...
      <StyledPressable
          ...
          <StyledImage source={google} className='w-10 h-10'></StyledImage>
