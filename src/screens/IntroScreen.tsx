...
export default function IntroScreen({navigation}: NoAuthScreenProps<'Intro'>) {
  return (
    <StyledComponent component={View} className="flex-1 flex-col bg-amber-100 justify-between">

      {/* Header */}
      <StyledComponent component={View} tw="mt-8">
        <StyledComponent component={Text} tw="text-4xl text-black font-bold text-center">
          CREA TU RUTINA MATINAL
        </StyledComponent>
      </StyledComponent>

      {/* Content */}
      <StyledComponent component={View} className='flex-1 justify-evenly ml-6 mr-6'>

        {/* Division 1 */}
        <StyledComponent component={View} className='flex-row justify-start pl-6 pr-9 h-28 bg-blue-500 rounded-tl-3xl rounded-br-3xl'>
            <StyledComponent component={Image} source={ejercicio} className='h-24 w-24 self-center p-10'></StyledComponent>
          
          <StyledComponent component={Text} className='text-black w-40 text-left self-center pl-8'>HAZ EJERCICIO</StyledComponent>

        </StyledComponent>

        {/* Division 2 */}
        <StyledComponent component={View} className='flex-row justify-start pl-6 pr-9 h-28 bg-green-500 rounded-tl-3xl rounded-br-3xl'>
            <StyledComponent component={Image} source={comida} className='h-24 w-24 self-center'></StyledComponent>
          
          <StyledComponent component={Text} className='text-black w-40 text-left self-center pl-8'>COCINA ALGO RICO</StyledComponent>
